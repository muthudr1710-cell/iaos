...
// Auto-generated stub for "Expense & Cost Controls". Tenant-scoped CRUD — build on it.
const SLUG = "expense_cost_controls";
...
export default function ExpenseCostControlsPage() {
