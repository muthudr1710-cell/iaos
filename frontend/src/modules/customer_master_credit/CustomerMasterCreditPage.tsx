...
// Auto-generated stub for "Customer Master & Credit". Tenant-scoped CRUD — build on it.
const SLUG = "customer_master_credit";
...
export default function CustomerMasterCreditPage() {
