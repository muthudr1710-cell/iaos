...
// Auto-generated stub for "Cost Audit & Overheads". Tenant-scoped CRUD — build on it.
const SLUG = "cost_audit_overheads";
...
export default function CostAuditOverheadsPage() {
