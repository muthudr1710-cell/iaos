...
// Auto-generated stub for "Borrowings & Covenants". Tenant-scoped CRUD — build on it.
const SLUG = "borrowings_covenants";
...
export default function BorrowingsCovenantsPage() {
